      ...
      <header className="top-0 z-50 border-b border-pink-200 bg-gradient-to-r from-pink-100 to-pink-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-pink-800">Specialized Doctors</h1>
              <p className="mt-1 text-sm sm:text-base text-pink-600">Cancer and Psychology Experts</p>
            </div>
